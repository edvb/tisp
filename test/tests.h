char *tests[][2] = {
	...
	{ "(Sym 1 2 3 4)",                 "'1234"                      },
	{ "(Sym 1 2. 3/4)",                "'12.03/4"                   },
	{ "(Str fst ffst quote)",          "\"fstffstquote\""           },
	{ "(Str def eval defmacro)",       "\"defevaldefmacro\""        },
	{ "(Str Nil 'hey True Nil Void)",  "\"NilheyTrueNilVoid\""      },
	{ "(Str (Func x x))",              "\"anon\""                   },
	{ "(Str fst (Macro (x) (+ x 1)))", "\"fstanon\""                },
	{ "(Str (Pair 'hello 'there))",    "\"hellothere\""             },
	{ "(Str [1 2 3])",                 "\"123\""                    },
	{ "(Str { a: 1  b: 2 })",          "\"a:1b:2\""                 },
	...
	/* { "str tib",                       NULL         }, */
	/* { "split(\"hey,there\" \",\")", "(hey there)" }, */
	/* { "split(\"end of col-de-sac\" \" \")", "(end of col-de-sac)" }, */
	/* { "split(\"end of col-de-sac\" \" -\")", "(end of col de sac)" }, */

	{ "records", NULL                                                                     },
	{ "(Rec (thewire \"TV Show\"))",
		"{ thewire: \"TV Show\" }"                                                    },
	{ "((Rec (thewire 2005)) 'thewire)",
		"2005"                                                                        },
	{ "(Rec (mcnulty 'cop) (omar 'robber) (stringer 'dealer))",
		"{ mcnulty: 'cop omar: 'robber stringer: 'dealer }"                           },
	{ "((Rec mcnulty: 'cop omar: 'robber stringer: 'dealer) 'omar)",
		"'robber"                                                                     },
	{ "({ (mcnulty \"cop\") (omar 'robber) (stringer 34) } 'mcnulty)",
		"\"cop\""                                                                     },
	{ "{ snoop: (- 2024 1990) marlo: (Int 25.75) avon: () stringer: \"dead\" }",
		"{ snoop: 34 stringer: \"dead\" avon: Nil marlo: 25 }"                        },
	{ "map(@it::name [{name: 'randy } {name: 'dukie} {name: 'micheal}])",
		"['randy 'dukie 'micheal]"                                                    },
	{ "(def rec {a: 1 b: 2 c: 3 d: 4 })", "Void"                                          },
	{ "(def omar { name: \"Omar Little\"  age: (- 2008 1966)  alive: False })", "Void"    },
	{ "rec",             "{ d: 4 c: 3 b: 2 a: 1 }"                                        },
	{ "rec::a",          "1"                                                              },
	{ "rec::b",          "2"                                                              },
	{ "rec::c",          "3"                                                              },
	{ "rec::d",          "4"                                                              },
	{ "(records rec)",   "[['d ... 4] ['c ... 3] ['b ... 2] ['a ... 1]]"                  },
	{ "(records omar)",  "[['name ... \"Omar Little\"] ['alive] ['age ... 42]]"           },
	{ "omar('name)",     "\"Omar Little\""                                                },
	{ "omar('age)",      "42"                                                             },
	{ "omar('alive)",    "Nil"                                                            },
	/* { "(keys rec)",   "'(c b a)"                                                       }, */
	/* { "(values rec)", "'(3 2 1)"                                                       }, */
	...
	{ "(recmerge rec { e: 5 })",
		"{ d: 4 c: 3 b: 2 a: 1 e: 5 }"                            },
	{ "omar{ height: (+ (* 5 12) 10) }",
		"{ name: \"Omar Little\" alive: Nil age: 42 height: 70 }" },

	{ "fst/rst",                                   NULL        },
	{ "(fst (Pair 1 2))",                          "1"         },
	{ "(rst (Pair 1 2))",                          "2"         },
	{ "(fst (quote (1 2 3 4)))",                   "1"         },
	{ "(fst (rst (quote (1 2 3 4))))",             "2"         },
	{ "(fst (rst (rst (quote (1 2 3 4)))))",       "3"         },
	{ "(fst (rst (rst (rst (quote (1 2 3 4))))))", "4"         },
	{ "(rst (quote (1 2 3 4)))",                   "[2 3 4]"   },
	{ "(rst (rst (quote (1 2 3 4))))",             "[3 4]"     },
	{ "(fst (Pair 1 (Pair 2 3)))",                 "1"         },
	{ "(rst (Pair 1 (Pair 2 3)))",                 "[2 ... 3]" },
	{ "(rst (rst (Pair 1 (Pair 2 3))))",           "3"         },
	{ "(fst (rrrst [1 2 3 4 5]))",                 "4"         },
	{ "(rfst [[1 2] 3 4 5])",                      "[2]"       },
	{ "(rfrst [1 [2 3 4] 5])",                     "[3 4]"     },
	...
	{ "string?('blinky)",                              "Nil"   },
	{ "symbol?('inky)",                                "True"  },
	{ "symbol?('~mrs. pacman~)",                       "True"  },
	{ "symbol?(3)",                                    "Nil"   },
	{ "primitive?(fst)",                               "True"  },
	{ "primitive?(def)",                               "Nil"   },
	{ "specialform?(quote)",                           "True"  },
	{ "specialform?(defmacro)",                        "Nil"   },
	{ "function?(ffst)",                               "True"  },
	{ "function?((Func (x) (+ x 2)))",                 "True"  },
	{ "function?(cond)",                               "Nil"   },
	{ "macro?(quasiquote)",                            "True"  },
	{ "macro?((Macro (x) (+ x 2)))",                   "True"  },
	{ "macro?(map)",                                   "Nil"   },
	{ "record?({a: 1 b: 2 })",                         "True"  },
	{ "record?('((a . 1) (b . 2)))",                   "Nil"   },

	{ "procprops",       NULL                                                      },
	{ "procprops(fst)",  "{ name: 'fst }"                                          },
	{ "procprops(list)", "{ name: 'list body: [\"Create list\" 'lst] args: 'lst }" },
	...
	{ "(if (ratio? fst) (Pair 1 2) (fst '(1 2)))",            "1"       },
	{ "(when True 'foo)",                                     "'foo"    },
	{ "(when () 'b  ar)",                                     "Void"    },
	{ "(when (= 1 1) 4)",                                     "4"       },
	...
	{ "let/recur",                 NULL },
	{ "(let (a: 1 b: 2) (+ a b))", "3"  },
	{ "(let (foo: (^ 2 3) bar: string?(version) baz: factorial(5)) (when bar (* baz foo)))",
		"960"                       },
	...
	{ "(map rst '((1 a) (2 b) (3 c)))",                         "[['a] ['b] ['c]]"      },
	{ "(map (Func (x) (fst (rst x))) '((1 a) (2 b) (3 c)))",    "['a 'b 'c]"            },
	{ "(map snd '((1/2 .5) (\"conky\" .25) ('bubbles .125)))", "[0.5 0.25 0.125]"      },
	{ "(map inc (list 2 4 8 (^ 2 4)))",                         "[3 5 9 17]"            },
	{ "(map dec [1 2 3 ... 4])",                                "[0 1 2 ... 3]"         },
	{ "(map / [1 2 3 ... 4])",                                  "[1 1/2 1/3 ... 1/4]"   },
